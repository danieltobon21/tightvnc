...
void CommonControlsEx::init()
{
  ...
  // ICC_STANDARD_CLASSES is what gives the standard controls (button, edit,
  // static, list box, combo box) their themed look when the process opts into
  // the version 6 of the common controls through the manifest.
  iccsex.dwICC = ICC_STANDARD_CLASSES |
